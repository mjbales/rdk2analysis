...
class RDK2MCAnalysis : public TNamed
{
    public:

        ///Constructers/Destructers
        RDK2MCAnalysis();
        RDK2MCAnalysis(TString inpName, TString inpTitle, int num3, TString p3RID, TString e3RID, int num4,TString p4RID, TString e4RID,TString g4RID, RDK2CutSet inpCutSet);
        RDK2MCAnalysis(TString inpName, TString inpTitle, RDK2Set inp3Set, RDK2Set inp4Set, RDK2CutSet inpCutSet);
        virtual ~RDK2MCAnalysis();
    ...
    protected:
        ...
        double epgPer4Decay; //EPG Dection Rate per decay
        double epgPer4DecayError; //EPG Dection Rate per decay error

        double epbgPer4Decay; //EPG Dection Rate per decay
        double epbgPer4DecayError; //EPG Dection Rate per decay error
    ...
    public:
        ClassDef(RDK2MCAnalysis,1); //Class to analyze RDK
};
