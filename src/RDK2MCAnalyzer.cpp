...
ClassImp(RDK2MCAnalysis);

RDK2MCAnalysis::RDK2MCAnalysis()
{
...
void RDK2MCAnalysis::ResetHists()
{
    delete ep_eEHist;
    delete ep_pEHist;
    delete ep_pTHist;
...
RDK2MCAnalysis::RDK2MCAnalysis(TString inpName, TString inpTitle, int num3, TString p3RID, TString e3RID, int num4,TString p4RID, TString e4RID,TString g4RID, RDK2CutSet inpCutSet)
{
    NULLHists();
    epPer3Decay=0;
    epPer3DecayError=0;
...
RDK2MCAnalysis::RDK2MCAnalysis(TString inpName, TString inpTitle, RDK2Set inp3Set, RDK2Set inp4Set, RDK2CutSet inpCutSet)
{
...
TH1* RDK2MCAnalysis::MakeHist(TString histName,EveType inpEveType,TString drawString,TCut inpCut,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeHist(TString histName,EveType inpEveType,TString drawString,TCut inpCut,TH1* histPrototype)
{
    TH1* outHist=NULL;
    if(inpEveType==THREEBODY)
    {
        outHist=(TH1*) threeBodySet.makeHist(histName,drawString,inpCut,histPrototype);
    }
    else
    {
        outHist=(TH1*) fourBodySet.makeHist(histName,drawString,inpCut,histPrototype);
    }
    return outHist;
}

TH1* RDK2MCAnalysis::MakeRatioHist(TString histName,TString drawString,TCut inpCut,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeRatioHist(TString histName,TString drawString,TCut inpCut,TH1* histPrototype)
{
    TH1* outHist=NULL;
...
TH1* RDK2MCAnalysis::MakeRadHist(TString histName,CoDet detType,TString drawString,int gOption,int det,TH1* histPrototype)
{
    TH1* outHist=NULL;
    TCut additionalCut;
...
TH1* RDK2MCAnalysis::MakeRadHist(TString histName,CoDet detType,TString drawString,int gOption,int det,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeFalseRadHist(TString histName,CoDet detType,TString drawString,int gOption,int det,TH1* histPrototype)
{
    TH1* outHist=NULL;
...
TH1* RDK2MCAnalysis::MakeFalseRadHist(TString histName,CoDet detType,TString drawString,int gOption,int det,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeRadAvgHist(TString histName,CoDet detType,TString drawString,int gOption,TH1* histPrototype)
{
    int numDets=0;
    if(detType==DET_EPG || detType==DET_G)
    {
...
TH1* RDK2MCAnalysis::MakeRadAvgHist(TString histName,CoDet detType,TString drawString,int gOption,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeFalseRadAvgHist(TString histName,CoDet detType,TString drawString,int gOption,TH1* histPrototype)
{
    int numDets=0;
    if(detType==DET_EPG)
    {
...
TH1* RDK2MCAnalysis::MakeFalseRadAvgHist(TString histName,CoDet detType,TString drawString,int gOption,HistDim inpHistDimX, HistDim inpHistDimY,HistDim inpHistDimZ)
{
    gROOT->cd();
    TH1* histPrototype;
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeStandardHist(TString histName,CoDet detType,TString drawString,HistDim inpHistDimX)
{
    TH1* outHist;
...
TH1* RDK2MCAnalysis::MakeMultiplicityHist()
{
...
double RDK2MCAnalysis::CalcPPer3Decay(double& error)
{
...
double RDK2MCAnalysis::CalcEPer3Decay(double& error)
{
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcPPer4Decay(double& error)
{
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcEPer4Decay(double& error)
{
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcEPPer3Decay(double& error)
{
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcEPPer4Decay(double& error)
{
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcGPer4Decay(CoDet detType,double& error)
{
    double answer=0;
    error=0;
    HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcEPGPer4Decay(CoDet detType,double& error)
{
	double answer=0;
	error=0;
	HistDim simpleDim={3,-10,800};
...
double RDK2MCAnalysis::CalcEPGPerEP(CoDet detType,double& error)
{
    double tempError;
    double answer;
    if(epPer3Decay == 0)
...
double RDK2MCAnalysis::CalcEPFalseGPerEP(CoDet detType,double& error)
{
    double answer;
    HistDim simpleDim={3,-10,800};
...
void RDK2MCAnalysis::PrintRates()
{
...
RDK2MCAnalysis* getRDK2MCAnalysis(TString inpString)
{
    TString filePath=ANALYSIS_DIR;
    filePath+=inpString+ ".root";
    TFile f(filePath);
    RDK2MCAnalysis* theAnal=(RDK2MCAnalysis*) f.Get(inpString);
    gROOT->cd();
    theAnal=(RDK2MCAnalysis*) theAnal->Clone(inpString+"temp");
